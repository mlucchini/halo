...
describe('weather reducer', () => {
  it('should handle RECEIVE_CITY_WEATHER', () => {
    ...
    expect(state.country).toEqual('GB')
    expect(state.hours).toEqual(19)
    expect(state.temperature).toEqual(280)
    expect(state.wind).toEqual(4.1)
    expect(state.clouds).toEqual(90)
    expect(state.rain).toEqual(0)
    expect(state.snow).toEqual(0)
    expect(state.all.slice(0, 8)).toEqual([
      {
        clouds: 90,
        hours: 19,
        rain: 0,
